...
Generates a CA and certificates for multiple nodes in the distributed network.
...
NODES = [
    {"id": "node1", "hostname": "node1", "ip": "172.20.0.11"},
    {"id": "node2", "hostname": "node2", "ip": "172.20.0.12"},
    {"id": "node3", "hostname": "node3", "ip": "172.20.0.13"},
]
...
def generate_ca_cert(key, common_name="Massir Network CA"):
    """Generate a CA certificate."""
    subject = issuer = x509.Name([
        x509.NameAttribute(NameOID.COUNTRY_NAME, "US"),
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Massir Network"),
...
def generate_node_cert(ca_key, ca_cert, node):
    ...
    # Build SAN: localhost + node hostname + IP + all other node hostnames
    san_list = [
    ...
    # Add all other nodes as SAN so they can connect
...
def main():
    """Generate all certificates for the multi-node network."""
